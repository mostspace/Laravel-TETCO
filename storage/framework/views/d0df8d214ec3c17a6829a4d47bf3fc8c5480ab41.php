...
<html lang="en">
	...
	<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
		...
		<div class="d-flex flex-column flex-root">
			...
			<div class="login login-2 login-signin-on d-flex flex-column flex-lg-row flex-column-fluid bg-white position-relative" id="kt_login">
                <a href="/" class="position-absolute ml-8 mt-10 zindex-5">
                    <img src="<?php echo e(asset('assets/media/logos/logo.png')); ?>" class="max-h-75px w-75" alt="" />
                </a>
				<!--begin::Aside-->
		...
		<script src="<?php echo e(asset('assets/js/login-general.js')); ?>"></script>
		<?php echo $__env->yieldContent('add_js'); ?>
		<!--end::Page Scripts-->
	</body>
	<!--end::Body-->
</html><?php /**PATH D:\Work\Works\Web\Tetco\resources\views/auth/login.blade.php ENDPATH**/ ?>